...
export default {
            ...
            <div class="sidebar">
                ...
                <form class="options">
                    ...
                    <div class="check">
                        ...
                        <label for="demoted">Demoted List</label>
                    </div>
    ...
    methods: {
        ...
        async onStart() {
            ...
            if (this.useLegacyList) list.push(...fullListMapped.slice(151, 239));
            if (this.useDemotedList) list.push(...fullListMapped.slice(239, 329));
